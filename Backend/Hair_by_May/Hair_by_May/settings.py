"""
Django settings for Hair_by_May project.
...
SECRET_KEY = 'django-insecure-zevx_)o77eo^mxc9!5djyvsdiqbn3aivja0^v$9yptn=)y+svs'
...
WSGI_APPLICATION = 'Hair_by_May.wsgi.application'
